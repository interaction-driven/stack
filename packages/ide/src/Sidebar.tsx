...
import UseCaseIcon from "./assets/use-case.svg";
            ...
            {menu.map(({ title, Icon }, index) => (
              <li>
                <a
                  ...
                  className={
                    index === active
                      ? "bg-gray-50 text-gray-sel group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                      : "text-gray-nor hover:text-gray-sel hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6"
                  }
                >
